...
STATE_GRID_SIZE = 4
STATE_BASE_POWER_BUCKETING = 5
STATE_ARMY_POWER_BUCKETING = 5
STATE_SELF_ARMY_BUCKETING = 2
...
DETAILED_STATE_MINERALS_IDX = 7
DETAILED_STATE_HOTSPOTS_IDX = 8
DETAILED_STATE_SIZE = 9
...
class TestAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        try:
            ...
            if self.move_number == 0:
                ...
                if smart_action == ID_ACTION_BUILD_BARRACKS or smart_action == ID_ACTION_BUILD_SUPPLY_DEPOT:
                ...
                elif smart_action == ID_ACTION_BUILD_MARINE:
                ...
                elif smart_action == ID_ACTION_ATTACK:
                ...
                smart_action = self.previous_action
                if smart_action == ID_ACTION_BUILD_SUPPLY_DEPOT:
                ...
                elif smart_action == ID_ACTION_BUILD_BARRACKS:
    ...
    def CreateState(self, obs):
        commandCenterCount, supplyDepotCount, barracksCount = self.GetBuildingCounts()
    ...
    def AddNewBuilding(self, obs):
        for itr in self.buildCommands[:]:
            ...
            if isBuilt:
                ...
                buildingPnt_y, buildingPnt_x = IsolateBuilding(loc, buildingMap)
    ...
    def RemoveDestroyedBuildings(self, obs):
        ...
        self.buildingVec = list(set(self.buildingVec))
        toRemove = []
    ...
    def GetBuildingCounts(self):
        ...
        return ccCount,  sdCount, baCount
    ...
    def ScaleCurrState(self):
        ...
        if loc != STATE_NON_VALID_NUM:
            ...
            self.current_scaled_state[STATE_ENEMY_ARMY_POWER_IDX] = math.ceil(self.current_state[STATE_ENEMY_ARMY_POWER_IDX] / STATE_ARMY_POWER_BUCKETING) * STATE_ARMY_POWER_BUCKETING  
        
        if  self.current_state[STATE_ENEMY_BASE_POWER_IDX] != STATE_NON_VALID_NUM:
            self.current_scaled_state[STATE_ENEMY_BASE_POWER_IDX] = math.ceil(self.current_state[STATE_ENEMY_BASE_POWER_IDX] / STATE_BASE_POWER_BUCKETING) * STATE_BASE_POWER_BUCKETING  
    ...
    def IsBaseDestroyed(self, selfMat, enemyMat, obs, radius2SelfCheck = 5, radius2EnemyCheck = 5):
