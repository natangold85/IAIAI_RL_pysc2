...
RUN_TYPES[QTABLE_GS5][Q_TABLE] = "baseBattle_qGS5_qtable"
RUN_TYPES[QTABLE_GS5][HISTORY] = "baseBattle_qGS5_replayHistory"
RUN_TYPES[QTABLE_GS5][RESULTS] = "baseBattle_qGS5_result"

RUN_TYPES[DQN_GS5_ARMY] = {}
RUN_TYPES[DQN_GS5_ARMY][TYPE] = "NN"
RUN_TYPES[DQN_GS5_ARMY][GRIDSIZE_key] = 5
RUN_TYPES[DQN_GS5_ARMY][PARAMS] = DQN_EMBEDDING_PARAMS(NumStateVal(5), NumStateLocationsVal(5), NumActions(5), states2Monitor = BaseTestSet(5))
RUN_TYPES[DQN_GS5_ARMY][NN] = "baseBattle_dqnGS5_DQN"
RUN_TYPES[DQN_GS5_ARMY][Q_TABLE] = ""
RUN_TYPES[DQN_GS5_ARMY][HISTORY] = "baseBattle_dqnGS5_replayHistory"
RUN_TYPES[DQN_GS5_ARMY][RESULTS] = "baseBattle_dqnGS5_result"
...
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][NN] = "baseBattle_dqnGS5_Embedding_DQN"
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][Q_TABLE] = ""
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][HISTORY] = "baseBattle_dqnGS5_Embedding_replayHistory"
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][RESULTS] = "baseBattle_dqnGS5_Embedding_result"
...
class Attack(base_agent.BaseAgent):
    def __init__(self, isSubAgent = False):        
