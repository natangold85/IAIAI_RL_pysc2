...
ALL_TYPES = set([USER_PLAY, QTABLE_GS5, DQN_GS5_ARMY, DQN_GS5_EMBEDDING_LOCATIONS])
...
# table names
BASE_ATTACK_RUN_TYPES = {}

BASE_ATTACK_RUN_TYPES[QTABLE_GS5] = {}
BASE_ATTACK_RUN_TYPES[QTABLE_GS5][TYPE] = "QReplay"
BASE_ATTACK_RUN_TYPES[QTABLE_GS5][GRIDSIZE_key] = 5
BASE_ATTACK_RUN_TYPES[QTABLE_GS5][PARAMS] = QTableParamsExplorationDecay(NumStateVal(5), NumActions(5))
BASE_ATTACK_RUN_TYPES[QTABLE_GS5][NN] = ""
BASE_ATTACK_RUN_TYPES[QTABLE_GS5][Q_TABLE] = "baseBattle_qGS5_qtable"
BASE_ATTACK_RUN_TYPES[QTABLE_GS5][HISTORY] = "baseBattle_qGS5_replayHistory"
BASE_ATTACK_RUN_TYPES[QTABLE_GS5][RESULTS] = "baseBattle_qGS5_result"

BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY] = {}
BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY][TYPE] = "NN"
BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY][GRIDSIZE_key] = 5
BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY][PARAMS] = DQN_PARAMS(NumStateVal(5), NumActions(5))
BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY][NN] = "baseBattle_dqnGS5_DQN"
BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY][Q_TABLE] = ""
BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY][HISTORY] = "baseBattle_dqnGS5_replayHistory"
BASE_ATTACK_RUN_TYPES[DQN_GS5_ARMY][RESULTS] = "baseBattle_dqnGS5_result"

BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS] = {}
BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][TYPE] = "NN"
BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][GRIDSIZE_key] = 5
BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][PARAMS] = DQN_EMBEDDING_PARAMS(NumStateVal(5), NumStateLocationsVal(5), NumActions(5))
BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][NN] = "baseBattle_dqnGS5_Embedding_DQN"
BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][Q_TABLE] = ""
BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][HISTORY] = "baseBattle_dqnGS5_Embedding_replayHistory"
BASE_ATTACK_RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][RESULTS] = "baseBattle_dqnGS5_Embedding_result"

BASE_ATTACK_RUN_TYPES[USER_PLAY] = {}
BASE_ATTACK_RUN_TYPES[USER_PLAY][GRIDSIZE_key] = 5
BASE_ATTACK_RUN_TYPES[USER_PLAY][TYPE] = "play"
...
class BaseAttack(base_agent.BaseAgent):
    def __init__(self, mainAgent = True, runArg = '', tfSession = None):        
        ...
        runType = BASE_ATTACK_RUN_TYPES[runArg]
        ...
        self.state_startBuildingMat = self.gridSize * self.gridSize
    ...
    def ValidActions(self):
        ...
        return list(set(locBuildings + [self.gridSize * self.gridSize]))
