...
from utils_tables import NeuralNetwork
...
NN_DIR_NAME = 'nn_test'
NN_RESULT_FILE_NAME = "melee_agent_neural_network"
...
class Attack(base_agent.BaseAgent):
    def __init__(self):        
        ...
        # init neural network:
        features = []
        features.append("self_location")
        features.append("last_attack_action")
        features.append("enemy1_location")
        features.append("enemy2_location")
        self.nn = NeuralNetwork(features, NUM_ACTIONS, NN_DIR_NAME, NN_RESULT_FILE_NAME)        
        # states and action:
    ...
    def step(self, obs):
        ...
        self.numStep += 1
        self.Learn()
        self.current_action = self.nn.choose_action(str(self.current_scaled_state))
    ...
    def CreateState(self, obs):
        ...
        state[:] = self.current_scaled_state[:]
