...
RUN_TYPES[QTABLE_GS5][Q_TABLE] = "armyBattle_qGS5_qtable"
RUN_TYPES[QTABLE_GS5][HISTORY] = "armyBattle_qGS5_replayHistory"
RUN_TYPES[QTABLE_GS5][RESULTS] = "armyBattle_qGS5_result"

RUN_TYPES[DQN_GS5_ARMY] = {}
RUN_TYPES[DQN_GS5_ARMY][TYPE] = "NN"
RUN_TYPES[DQN_GS5_ARMY][GRIDSIZE_key] = 5
RUN_TYPES[DQN_GS5_ARMY][PARAMS] = DQN_PARAMS(NumStateVal(5), NumStateLocationsVal(5), NumActions(5), states2Monitor = BaseTestSet(5))
RUN_TYPES[DQN_GS5_ARMY][NN] = "armyBattle_dqnGS5_DQN"
RUN_TYPES[DQN_GS5_ARMY][Q_TABLE] = ""
RUN_TYPES[DQN_GS5_ARMY][HISTORY] = "armyBattle_dqnGS5_replayHistory"
RUN_TYPES[DQN_GS5_ARMY][RESULTS] = "armyBattle_dqnGS5_result"
...
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][NN] = "armyBattle_dqnGS5_Embedding_DQN"
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][Q_TABLE] = ""
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][HISTORY] = "armyBattle_dqnGS5_Embedding_replayHistory"
RUN_TYPES[DQN_GS5_EMBEDDING_LOCATIONS][RESULTS] = "armyBattle_dqnGS5_Embedding_result"

RUN_TYPES[DQN_GS5_2LAYERS] = {}
RUN_TYPES[DQN_GS5_2LAYERS][TYPE] = "NN"
RUN_TYPES[DQN_GS5_2LAYERS][GRIDSIZE_key] = 5
RUN_TYPES[DQN_GS5_2LAYERS][PARAMS] = DQN_PARAMS(NumStateVal(5), NumStateLocationsVal(5), NumActions(5), states2Monitor = BaseTestSet(5), nn_Func = NNFunc_2Layers)
RUN_TYPES[DQN_GS5_2LAYERS][NN] = "armyBattle_dqnGS5_2Layers_DQN"
RUN_TYPES[DQN_GS5_2LAYERS][Q_TABLE] = ""
RUN_TYPES[DQN_GS5_2LAYERS][HISTORY] = "armyBattle_dqnGS5_2Layers_replayHistory"
RUN_TYPES[DQN_GS5_2LAYERS][RESULTS] = "armyBattle_dqnGS5_2Layers_result"
